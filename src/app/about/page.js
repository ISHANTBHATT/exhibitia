  ...
  return (
    <div className="min-h-screen  py-10">
      ...
      <div className="container mx-auto py-12">
        ...
        <div className="flex flex-col flex-wrap lg:flex-nowrap gap-8 items-start">
          <div className="w-full lg:pl-20 pt-10">
            <h2 className="text-5xl font-bold mt-2 mb-6 leading-tight text-center">
              Welcome to Exhibitia
            </h2>
            <p className="text-gray-600 mb-8">
              where creativity meets functionality in the world of exhibition
